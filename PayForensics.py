...
"""
    ...
    if query.strip():
        ...
        if not api_key:
            ...
            st.warning(
                "🔑 AI Investigator is not configured yet. "
                "Add GEMINI_API_KEY in Streamlit Cloud → Settings → Secrets "
...
# ============================================================
    ...
    # ========================================================
    # The API key is intentionally NOT stored in this Python file.
    #
    ...
    #
    # Local development:
    #   set GEMINI_API_KEY as an environment variable, or use
    #   .streamlit/secrets.toml (which must never be committed).
    #
    # The key is loaded only at runtime.
    api_key = os.getenv("GEMINI_API_KEY", "").strip()
